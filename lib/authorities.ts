...
export const authorities: Authority[] = [
  ...
  { name: "BRA", full: "Balochistan Revenue Authority", logo: "/bra.jpg" },
  { name: "SECP", full: "Securities & Exchange Commission of Pakistan", logo: "/secp.jpg" },
  { name: "PSW", full: "Pakistan Single Window", logo: "/psw.jpg" },
  ...
  { name: "PSEB", full: "Pakistan Software Export Board", logo: "/pseb.jpg" },
  { name: "Chamber of Commerce", full: "Chambers of Commerce (RCCI, LCCI, etc.)", logo: "/coc.jpg" },
];
